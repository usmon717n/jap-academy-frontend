  ...
  return (
    <footer className="relative mt-24 overflow-hidden border-t border-white/6 pb-12">
      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-20 pb-10">
          ...
          <div className="flex flex-col items-center sm:items-start">
            ...
            <div className="flex gap-3">
              {[
                ...
                {
                  h: "https://instagram.com/japacademy",
                ...
                {
                  h: "https://youtube.com/@japacademy",
                ...
                <a key={idx} href={s.h} target="_blank" rel="noopener"
        ...
        {/* Divider with element formula */}
        <div className="pt-10 border-t border-white/6 flex flex-col items-center md:flex-row md:justify-between gap-8">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            <a
              ...
              target="_blank"
              rel="noopener"
              className="group flex items-center gap-2.5 px-3 py-1.5 rounded-lg bg-sky-950/60 border border-sky-900/40 transition-all hover:bg-sky-900/40"
            >
              <div className="w-6 h-6 rounded-md bg-sky-500/80 flex items-center justify-center text-white shadow-sm">
              ...
              <span className="text-[9px] font-black uppercase tracking-[0.2em] text-sky-400/80 group-hover:text-sky-400">{t.footer.developer}</span>
            </a>
