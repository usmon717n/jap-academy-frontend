        ...
        <div className="max-w-6xl mx-auto w-full flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 max-w-xl">
            ...
            <h1 className="text-4xl md:text-[52px] font-black tracking-tight leading-[1.06] mb-6">
              Kimyo fanini<br />
              <span className="bg-gradient-to-r from-orange-500 via-orange-600 to-amber-500 bg-clip-text text-transparent">zamonaviy</span>{' '}usulda<br />
              o&apos;rganing
            </h1>
          ...
          <div className="flex-1 flex justify-center">
            <svg viewBox="0 0 300 380" width="280" height="360" style={{ filter: 'drop-shadow(0 20px 40px rgba(234,88,12,0.12))' }}>
              ...
              <path d="M110 60V160L40 300C35 315 45 330 60 330H240C255 330 265 315 260 300L190 160V60" fill="url(#flaskG)" stroke="#ea580c" strokeWidth="1.5" strokeOpacity="0.3"/>
          ...
          {[
            ...
            <div key={i} className="card-hover p-6 rounded-2xl relative overflow-hidden group cursor-default" style={{
              ...
              <div className="relative z-10">
                ...
                <div className="text-sm font-extrabold mb-1.5 group-hover:text-orange-700 transition-colors">{f.title}</div>
